...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Player 1 이름을 입력하세요.");
        p1.setName(scanner.nextLine());
        System.out.println("Player 2 이름을 입력하세요.");
        ...
        while (Player.count >= 0) {
            if (Player.count % 2 == 0) {
                ...
                p1.getKeyboardInput(x, y);
            } else if (Player.count % 2 == 1){
                System.out.print("x 좌표를 입력하세요 : ");
                int x = scanner.nextInt();
                System.out.print("y 좌표를 입력하세요 : ");
                int y = scanner.nextInt();
                p2.getKeyboardInput(x, y);
            }
            for (int[] column : Position.stage) {
                for (int row : column) {
